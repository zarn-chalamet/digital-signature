    ...
    return (
        <div className="w-full h-full md:w-1/2">
            <div className='relative flex-col items-center justify-center hidden gap-8 lg:flex md:items-start'>
                <h1 className={cn('text-2xl font-medium leading-normal tracking-wide text-center md:text-3xl md:text-left', isDark && 'text-slate-50')}>
                    Sign in to <br />
                    <span className='text-primary'>Digital Signature System</span>
                </h1>
                <p className={cn('max-w-xs text-center md:text-left', isDark && 'text-slate-50')}>
            ...
            <div className='flex items-center justify-center gap-3 mb-4 lg:hidden'>
                ...
                <div className={cn('w-0.5 h-8  bg-gray-200', isDark && 'bg-gray-700')}></div>
