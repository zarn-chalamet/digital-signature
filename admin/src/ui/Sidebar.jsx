...
const Sidebar = forwardRef(({ collapsed }, ref) => {
    return (
        <aside
            ref={ref}
            className={cn(
                'fixed z-[100] dark:bg-slate-900 dark:border-slate-700 dark:border-r bg-white border-slate-300 border-r flex h-full w-[300px] flex-col overflow-x-hidden shadow-lg [transition:_width_300ms_cubic-bezier(0.4,_0,_0.2,_1),_left_300ms_cubic-bezier(0.4,_0,_0.2,_1),_background-color_150ms_cubic-bezier(0.4,_0,_0.2,_1),_border_150ms_cubic-bezier(0.4,_0,_0.2,_1)] ',
